...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="h-screen w-full snap-start flex items-center justify-center text-black dark:text-white px-6 md:px-12">
      <motion.div
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full p-3 rounded-lg bg-white/20 text-black dark:text-white placeholder-gray-800 outline-none focus:ring-2 focus:ring-white"
              />
              <input
                type="email"
                name="email"
              ...
              <textarea
                ...
                className="w-full p-3 rounded-lg bg-white/20 text-black dark:text-white placeholder-gray-800 outline-none focus:ring-2 focus:ring-white resize-none"
              />
              <button
                type="submit"
                className="w-full py-3 rounded-lg bg-white/80 text-black font-semibold hover:bg-white hover:scale-105 transition-all duration-300">
                Send Message
              </button>
            </form>
          )}
